            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="centrado">
                        ...
                        <a href="#" class="btn btn-primary medium">ADMINISTRADOR </a>
                    </div>
                    <div class="centrado">

                     <a href="#" class="btn btn-primary medium">PROFESOR </a>
                       </div>
                       <div class="centrado">

                     <a href="#" class="btn btn-primary medium">ESTUDIANTES </a>
                       </div>
                       <div class="centrado">

<a href="#" class="btn btn-primary medium">EGRESADOS </a>
  </div>
  <div class="centrado">

                     <a href="#" class="btn btn-primary medium">EMPRESARIO </a>
                       </div>
                </div>
